...
`;
    ...
    Part3:function(Aname, result1, result2) {
        ...
        HTMLCode += `
        <tr>
             <td colspan="4" style="height: 50px;" ><button style="font-size: 1.6em" class="g" onclick="setparts();">착용하기</button></td>
        </tr>
    ...
    Part4:function(Armors) {
        return `
        <div id="table"  style="visibility: visible;">
        <table style="table-layout: fixed;" class="total2" border="2" align="left" >
            <thead>
            <tr>
                <th>머리</th>
                <th>몸통</th>
            ...
            <tbody align="middle">
            <tr>
                <td id="headarmor">${Armors[0]}</td>
                <td id="bodyarmor">${Armors[1]}</td>
                <td id="armarmor">${Armors[2]}</td>
                <td id="waistarmor">${Armors[3]}</td>
                <td id="legarmor">${Armors[4]}</td>
    ...
    <table class="total" border="2" align="left" >
        ...
        <tbody align="middle">
        <tr>
            <td colspan ="2"  style="width: 50%;">총 방어력</td>
        ...
        <tr>
             <td colspan="4" style="height: 50px;" ><button style="font-size: 1.6em" class="g" onclick="calculate();">계산하기</button></td>
        </tr>
        </tbody>
    </table>
    </div>
